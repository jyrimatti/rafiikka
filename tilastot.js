...
let luoTilastoPopupAkselinlaskija                   = kk => luoTilastoPopup('Akselinlaskijat',                     elementitUrlTilasto("akselinlaskija"),                   names(kk ? kayttokeskukset : lisualueet), [''], ['']);
...
let luoTilastoPopupPysaytyslaite                    = kk => luoTilastoPopup('Pysäytyslaitteet',                    elementitUrlTilasto("pysaytyslaite"),                    names(kk ? kayttokeskukset : lisualueet), ['Käsin asetettava', 'Keskitetty'], ['Varmuuslukittu','Lukitsematon']);
let luoTilastoPopupRfidlukija                       = kk => luoTilastoPopup('RFID-lukijat',                        elementitUrlTilasto("rfidlukija"),                       names(kk ? kayttokeskukset : lisualueet), [''], ['']);
...
let luoTilastoPopupMaadoitin                        = kk => luoTilastoPopup('Maadoittimet',                        elementitUrlTilasto("maadoitin"),                        names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupTyonaikaineneristin              = kk => luoTilastoPopup('Työnaikaiset eristimet',              elementitUrlTilasto("tyonaikaineneristin"),              names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupKaantopoyta                      = kk => luoTilastoPopup('Kääntöpöydät',                        elementitUrlTilasto("kaantopoyta"),                      names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupPyoraprofiilimittalaite          = kk => luoTilastoPopup('Pyöräprofiilin mittalaitteet',        elementitUrlTilasto("pyoraprofiilimittalaite"),          names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupTelivalvonta                     = kk => luoTilastoPopup('Telivalvonnat',                       elementitUrlTilasto("telivalvonta"),                     names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupErotin                           = kk => luoTilastoPopup('Erottimet',                           elementitUrlTilasto("erotin"),                           names(kk ? kayttokeskukset : lisualueet), [''], ['']);
let luoTilastoPopupTasoristeysvalojenpyoratunnistin = kk => luoTilastoPopup('Tasoristeysvalojen pyörätunnistimet', elementitUrlTilasto("tasoristeysvalojenpyoratunnistin"), names(kk ? kayttokeskukset : lisualueet), [''], ['']);
